...
**Пороги оценки** (адаптируются по зрелости — Starter 🌱 без "Плохо"):
- Starter: 🌟80%+ / ✅60%+ / ⚠️40%+ / <40% Начало пути 🚀
- Growing: 🌟85%+ / ✅70%+ / ⚠️50%+ / <50% Требует внимания 🔧
- Mature/Pro: 🌟90%+ / ✅70%+ / ⚠️50%+ / <50% Плохо 🔴
...
Эта сводка ТОЛЬКО для `/doctor`. Для `/doctor layer <N>` достаточно строки оценки.
