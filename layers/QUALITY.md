...
## 2a. Linter + Formatter — инструменты настроены [core]
...
## 2b. PostToolUse hook — автопроверка Claude [cc]
...
## 2c. Pre-commit hook — барьер перед git [core]
...
## 2d. CI workflow — удалённая проверка (опционально) [advanced]
...
## 2e. Обработка ошибок — код не глотает ошибки [core]
...
## 2f. Pre-push hook — тесты перед отправкой [quality]
