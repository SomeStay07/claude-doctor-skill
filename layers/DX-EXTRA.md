...
## 5e. Автообновление зависимостей — Dependabot / Renovate [cc]
...
## 5f. Установщик хуков — `make hooks` для онбординга [core]
...
## 5g. Оптимизация скиллов — `disable-model-invocation` [quality]
